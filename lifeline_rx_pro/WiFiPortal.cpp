...
static String getPortalHTML() {
    ...
    String html = F(
        ...
        "body{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:14px 20px;}"
        ".frame{width:100%;max-width:1080px;max-height:96vh;display:flex;flex-direction:column;justify-content:space-between;}"
        ...
        ".card{border:1px solid var(--card-border);background:var(--card-outer);padding:20px;display:grid;grid-template-columns:1.25fr 1fr;gap:20px;box-shadow:0 4px 18px rgba(0,0,0,0.04);}"
        ...
        ".wifi-slot{background:var(--card-inner);border:1px solid var(--card-inner-border);padding:7px 10px;margin-bottom:6px;}"
        ".wifi-head{display:flex;justify-content:space-between;font-family:monospace;font-size:9.5px;font-weight:700;color:var(--text-muted);margin-bottom:3px;}"
        ".slot-row{display:grid;grid-template-columns:1.2fr 1fr;gap:6px;}"
        ...
        ".input-box{width:100%;padding:6px 10px;border:1px solid var(--input-border);background:var(--input-bg);color:var(--text-main);font-family:monospace;font-size:11.5px;outline:none;margin-bottom:4px;}"
        ...
        "<div class='check-item'>✓ Dual Partition Safe</div><div class='check-item'>✓ 433MHz LoRa Gateway</div>"
        "<div class='check-item'>✓ Tri-WiFi Redundancy</div><div class='check-item'>✓ 1602 LCD Live Sync</div>"
        "</div></div>"
