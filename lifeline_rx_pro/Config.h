...
#define RX_BLINK_DURATION_MS    4000    // Buzzer alert & LED ON duration (4 seconds) when data packet is received
...
const char* const alertNamesShort[ALERT_COUNT] = {
    "CRITICAL SOS", "DELIVERY SOS", "HELI RESCUE",  "MED SHORTAGE",
    "OXYGEN SHORT", "SEVERE INJUR", "BLOOD NEEDED", "ALTITUDE AMS",
    "FOOD SHORT",   "WATER SHORT",  "OUTBREAK",     "COLD SHELTER",
    "LANDSLIDE",    "DOCTOR REQ",   "STATUS OK"
};
